  ...
  return (
    <section className={styles['about-container']}>
      ...
      <div className={styles['text-container']}>
        ...
        Hello! My name is Tim, and I am currently studying to become a .NET Developer with a strong passion for web development. I thoroughly enjoy building modern, intuitive, and user-friendly applications that simplify and enhance users&rsquo; everyday lives. Designing solutions that not only look great but also function seamlessly is something I take pride in.
        <span className={styles.gap}></span> {/* Lägg till gapet här */}
        When I&rsquo;m not coding, I&rsquo;m often diving into new technologies, exploring innovative tools, and finding ways to sharpen my skills. Whether it&rsquo;s experimenting with a new framework or learning about the latest industry trends, I&rsquo;m always eager to grow as a developer. I believe that continuous learning and curiosity are key to becoming a great programmer.
        </p>        
